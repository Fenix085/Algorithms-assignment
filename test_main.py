...
class TestStuff(unittest.TestCase):
    def test_bubble_sorted(self):
        ...
        self.assertEqual(sorter.bubbleSort(arr), sort_arr)
    ...
    def test_insertion_sorted(self):
        arr = [16, 40, 52, 71, 86]
        sort_arr = [16, 40, 52, 71, 86]
        self.assertEqual(sorter.insertionSort(arr), sort_arr)
    ...
    def test_merge_sorted(self):
        arr = [16, 40, 52, 71, 86]
        sort_arr = [16, 40, 52, 71, 86]
        self.assertEqual(sorter.mergeSort(arr), sort_arr)
    ...
    def test_quick_sorted(self):
        arr = [16, 40, 52, 71, 86]
        sort_arr = [16, 40, 52, 71, 86]
        self.assertEqual(sorter.quickSort(arr), sort_arr)
